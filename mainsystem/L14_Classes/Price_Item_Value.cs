...
namespace mainsystem
{
    internal class Price_Item_Value
    {
        ...
        //codes for setting the value of the item name and item price, which are to be
        //stored inside the itemname and price variables
        ...
        //codes for setting the value of the discount amount and item price, which are to
        //be stored inside the discount_amt and priceItem variables
        ...
        //codes for getting the value of a discount_amount and using it as needed in the
        //application
